...
mod tests {
    ...
    fn test_hex_and_decimal_equivalence_edge_cases() {
        ...
        assert_eq!(parse_opcode_filter("0x0000").unwrap(), parse_opcode_filter("0").unwrap());
        
        // Test 0x0001 (1 decimal)
        assert_eq!(parse_opcode_filter("0x0001").unwrap(), parse_opcode_filter("1").unwrap());
        
        // Test 0xFFFF (65535 decimal)
        assert_eq!(parse_opcode_filter("0xFFFF").unwrap(), parse_opcode_filter("65535").unwrap());
    }
